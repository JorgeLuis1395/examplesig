...
public class FacturaSri {
    ...
    public class InfoFactura {
        ...
        public void agregarTotalConImpuestos(String codigo,
                String valor,
                String tarifa,
        ...
        @Override
        public String toString() {
            return "InfoFactura [totalSinImpuestos = " + totalSinImpuestos + ", contribuyenteEspecial = " + contribuyenteEspecial + ", propina = " + propina + ", totalDescuento = " + totalDescuento + ", dirEstablecimiento = " + dirEstablecimiento + ", totalConImpuestos = " + totalConImpuestos + ", moneda = " + moneda + ", obligadoContabilidad = " + obligadoContabilidad + ", fechaEmision = " + fechaEmision + ", razonSocialComprador = " + razonSocialComprador + ", tipoIdentificacionComprador = " + tipoIdentificacionComprador + ", identificacionComprador = " + identificacionComprador + ", importeTotal = " + importeTotal + "]";
        }
    }
    ...
    public class TotalImpuesto {
        ...
        @Override
        public String toString() {
            return "TotalImpuesto [codigo = " + codigo + ", valor = " + valor + ", descuentoAdicional = " + descuentoAdicional + ", codigoPorcentaje = " + codigoPorcentaje + ", baseImponible = " + baseImponible+ ", tarifa = " + tarifa + "]";
        }
