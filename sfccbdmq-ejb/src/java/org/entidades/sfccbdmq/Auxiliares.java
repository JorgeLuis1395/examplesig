...
@NamedQueries({
    ...
    , @NamedQuery(name = "Auxiliares.findByCodigo", query = "SELECT a FROM Auxiliares a WHERE a.codigo = :codigo")
    , @NamedQuery(name = "Auxiliares.findByNombre", query = "SELECT a FROM Auxiliares a WHERE a.nombre = :nombre")})
public class Auxiliares implements Serializable {
    ...
    public String toString() {
        return "org.entidades.sfccbdmq.Auxiliares[ id=" + id + " ]";
    }
