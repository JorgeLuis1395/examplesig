...
//@Singleton
//@LocalBean
//public class autorizarVacacionesSingleton {
//
...
//        Query q = em.createQuery("Select OBJECT(o) FROM Licencias as o where o.solicitud is not null"
//                + " and o.autoriza is not null and o.aprovado is null"
//                + " and o.tipo.diasaprobar is not null and o.tipo.diasaprobar=true");
//        List<Licencias> listaLicencias = q.getResultList();
//
//        List<Licencias> listaFiltrado = new LinkedList<>();
//        for (Licencias l1 : listaLicencias) {
//            double dias = consultaDias(l1.getSolicitud(), new Date());
//            if (l1.getTipo().getDiasaprobar().equals(dias)) {
//                listaFiltrado.add(l1);
//            }
//        }
//
//        for (Licencias l : listaFiltrado) {
//            // ver si son normales sin cargo a vacaiones
//            l.setFautoriza(hoy);
//            l.setObservaciones("Permiso Autorizado Automáticamente");
//            l.setFlegaliza(hoy);
//            l.setFretorno(l.getFin());
//            l.setLegalizado(Boolean.TRUE);
//            l.setObslegalizacion("Permiso Autorizado Automáticamente");
//            long cuanto = 0;
...
//                        q = em.createQuery("Select OBJECT(o) FROM Vaccaciones as o "
...
//                            vac.setUtilizados(utilizado);
//                            vac.setUtilizadofs(utilizadofs);
//                            em.persist(vac);
//                        } else {
//                            Integer vienen = vac.getUtilizados() == null ? 0 : vac.getUtilizados();
//                            Integer vienenfs = vac.getUtilizadofs() == null ? 0 : vac.getUtilizadofs();
//                            int utilizado = (int) (cuanto * 22 / 30);
//                            Integer utilizadofs = (int) (cuanto - utilizado);
//                            vac.setUtilizados(vienen + utilizado);
