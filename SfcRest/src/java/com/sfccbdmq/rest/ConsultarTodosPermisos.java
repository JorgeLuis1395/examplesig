 ...
 * @author edwin
 */
@Stateless(name = "consultarTodosPermisos")
@Path("consultarTodosPermisosRest")
public class ConsultarTodosPermisos {
     ...
     */
    public ConsultarTodosPermisos() {
    }

    @GET
    @Path("{consultarTodosPermisos}")
//    @Produces(MediaType.APPLICATION_JSON)
    @Produces({"application/json"})
    public Response getPedirVacaciones(@PathParam("consultarTodosPermisos") String parametro) throws ConsultarException {
