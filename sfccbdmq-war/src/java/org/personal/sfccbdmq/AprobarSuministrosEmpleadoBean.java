 ...
 * @author evconsul
 */
@ManagedBean(name = "aprobarSuministroEmpleado")
@ViewScoped
public class AprobarSuministrosEmpleadoBean implements Serializable {
...
//        }
     ...
     */
    public AprobarSuministrosEmpleadoBean() {
    }
...
//            parametros.put("trimestre", cuatrimestre);
            ...
            if (total > 0) {
                MensajesErrores.advertencia("Suministros ya planificados");
                return null;
            }
...
//            parametros.put("trimestre", cuatrimestre);
            ...
            Logger.getLogger(AprobarSuministrosEmpleadoBean.class.getName()).log(Level.SEVERE, null, ex);
        }
        if (listaEmpleadosuministros.isEmpty()) {
            MensajesErrores.advertencia("No existe nada planificado");
            return null;
        }
        formulario.insertar();
        return null;
...
//                e.setAprobadoinv(e.getCantidadinv());
                e.setFaprovado(new Date());
                e.setAprobador(empleadoBean.getEmpleadoSeleccionado());
