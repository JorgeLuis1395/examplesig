 ...
 * @author evconsul
 */
@ManagedBean(name = "recomendacionesEmpleado")
@ViewScoped
public class RecomendacionesEmpleadoBean implements Serializable {
...
//    private DocumentosempleadoFacade ejbDocumentos;
    ...
    private void activar() {
        ...
        String nombreForma = "RecomendacionesEmpleadosVista";
...
//        }
     ...
     */
    public RecomendacionesEmpleadoBean() {
    }
...
//            parametros.put(";orden", "o.fecha desc");
            ...
            Logger.getLogger(RecomendacionesEmpleadoBean.class.getName()).log(Level.SEVERE, null, ex);
        }
        return null;
    }
    ...
    public String nuevo() {
        ...
        recomendacion.setFechaingreso(new Date());
        recomendacion.setEmpleado(empleadoBean.getEmpleadoSeleccionado());
        Integer idEMpleado = empleadoBean.getEmpleadoSeleccionado().getId();
        imagenesBean.setIdModulo(idEMpleado);
        imagenesBean.setModulo("RECOMENDACION");
        imagenesBean.Buscar();
        getFormulario().insertar();
        return null;
    }

    public String modifica(Recomendaciones recomendacion) {
        this.recomendacion = recomendacion;
        imagenesBean.setIdModulo(recomendacion.getEmpleado().getId());
        imagenesBean.setModulo("RECOMENDACION");
        imagenesBean.Buscar();
    ...
    public String borra(Recomendaciones recomendacion) {
        this.recomendacion = recomendacion;
        getFormulario().eliminar();
        return null;
    }
    public String verifica(Recomendaciones recomendacion) {
        this.recomendacion = recomendacion;
    ...
    public String niega(Recomendaciones recomendacion) {
        this.recomendacion = recomendacion;
        recomendacion.setValidado(Boolean.TRUE);
        try {
            ejbRecomendaciones.edit(recomendacion, parametrosSeguridad.getLogueado().getUserid());
    ...
    public boolean validar() {
        ...
        if (recomendacion.getEmpresa()== null || recomendacion.getEmpresa().isEmpty()) {
            MensajesErrores.advertencia("Ingrese empresa");
            return true;
        }
        if (recomendacion.getNombre()== null || recomendacion.getNombre().isEmpty()) {
            MensajesErrores.advertencia("Ingrese nombre");
            return true;
        }
        if (recomendacion.getTelefono()== null || recomendacion.getTelefono().isEmpty()) {
            MensajesErrores.advertencia("Ingrese teléfono");
            return true;
        }
    ...
    public String insertar() {
        ...
        try {
            ejbRecomendaciones.create(recomendacion, parametrosSeguridad.getLogueado().getUserid());
    ...
    public String eliminar() {
        try {
            ...
            ejbRecomendaciones.remove(recomendacion, parametrosSeguridad.getLogueado().getUserid());
