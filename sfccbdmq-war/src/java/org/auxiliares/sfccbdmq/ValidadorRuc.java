 ...
 * @author edwin
 */
@FacesValidator("org.auxiliares.sfccbdmq.ValidadorRuc")
public class ValidadorRuc implements Validator {
    ...
    public void validate(FacesContext context, UIComponent component, Object value) throws ValidatorException {
        ...
        if (numero.substring(0, 1).equalsIgnoreCase("P")) {
            return;
        }
        int suma = 0;
        int residuo = 0;
        ...
        if (numero.length() > 13) {
            ...
            FacesMessage msg = new FacesMessage("RUC invalidado mayor a 13 caracteres");
            msg.setDetail(" RUC invalidado mayor a 13 caracteres");
            //msg.setSumamry("Fecha menor que Periodo Vigente");
            msg.setSeverity(FacesMessage.SEVERITY_ERROR);
            throw new ValidatorException(msg);
