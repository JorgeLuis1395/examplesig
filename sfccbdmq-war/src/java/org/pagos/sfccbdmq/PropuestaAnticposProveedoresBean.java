 ...
 * @author edwin
 */
@ManagedBean(name = "propuestaAnticiposProveedoresSfccbdmq")
@ViewScoped
public class PropuestaAnticposProveedoresBean {

    /**
     * Creates a new instance of AnticiposBean
     */
    public PropuestaAnticposProveedoresBean() {
    ...
    private List<Anticipos> listadoAnticipos;
    ...
    public String buscar() {
        ...
        parametros.put(";where", "o.estado=1");
        try {
            List<Contratos> listadoContratos = ejbContratos.encontarParametros(parametros);
            for (Contratos c : listadoContratos) {
                anticipo = new Anticipos();
                anticipo.setFechaemision(new Date());
                anticipo.setPagado(false);
                anticipo.setContrato(c);
                anticipo.setValor(c.getAnticipo());
                anticipo.setProveedor(c.getProveedor());
                anticipo.setEstado(0);
                if (validarAntes()) {
                    return null;
                }
                listadoAnticipos.add(anticipo);

            }
//            formulario.insertar();
        } catch (ConsultarException ex) {
            Logger.getLogger(PropuestaAnticposProveedoresBean.class.getName()).log(Level.SEVERE, null, ex);
        }
        return null;
    }

    public String buscarAnticipos() {
...
//                        // proveedor
//                        String xuNombre = getProveedorBean().taerRuc(r.getAuxiliar()).getNombre();
//                        r.setAuxiliarNombre(xuNombre);
//                    } else if (c.getAuxiliares().getParametros().equals("P")) {
//                        // empleado
//                        String xuNombre = empleadoBean.traerCedula(r.getAuxiliar());
//                        r.setAuxiliarNombre(xuNombre);
//                    } else if (c.getAuxiliares().getParametros().equals("P")) {
//                        // cliente
//                        String xuNombre = getProveedorBean().taerRuc(r.getAuxiliar()).getNombre();
...
//            }
            ...
            columnas.add(new AuxiliarReporte("String", 8, AuxiliarReporte.ALIGN_LEFT, 7, false, kardex.getBanco().toString()));
            columnas.add(new AuxiliarReporte("String", 8, AuxiliarReporte.ALIGN_LEFT, 7, false, "Fecha :"));
            columnas.add(new AuxiliarReporte("String", 8, AuxiliarReporte.ALIGN_LEFT, 7, false, sdf.format(kardex.getFechamov())));

            columnas.add(new AuxiliarReporte("String", 8, AuxiliarReporte.ALIGN_LEFT, 7, false, "Cuenta T:"));
            columnas.add(new AuxiliarReporte("String", 8, AuxiliarReporte.ALIGN_LEFT, 7, false, kardex.getCuentatrans()));
            ...
            columnas.add(new AuxiliarReporte("String", 8, AuxiliarReporte.ALIGN_LEFT, 7, false, kardex.getBeneficiario()));

            columnas.add(new AuxiliarReporte("String", 8, AuxiliarReporte.ALIGN_LEFT, 7, false, "Banco T :"));
            columnas.add(new AuxiliarReporte("String", 8, AuxiliarReporte.ALIGN_LEFT, 7, false, kardex.getBancotransferencia().toString()));

            columnas.add(new AuxiliarReporte("String", 8, AuxiliarReporte.ALIGN_LEFT, 7, false, "Valor:"));
            columnas.add(new AuxiliarReporte("String", 8, AuxiliarReporte.ALIGN_LEFT, 7, false, ConvertirNumeroALetras.convertNumberToLetter(kardex.getValor().doubleValue())));
            columnas.add(new AuxiliarReporte("String", 8, AuxiliarReporte.ALIGN_LEFT, 7, false, ""));

            columnas.add(new AuxiliarReporte("String", 8, AuxiliarReporte.ALIGN_LEFT, 7, false, df.format(kardex.getValor())));
            pdf.agregaParrafo("\n\n");
            pdf.agregaParrafo("\n\n");
...
//        i++;
     ...
     */
    public List<Anticipos> getListadoAnticipos() {
     ...
     */
    public void setListadoAnticipos(List<Anticipos> listadoAnticipos) {
