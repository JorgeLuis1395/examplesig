 ...
 * @author evconsul
 */
@ManagedBean(name = "pagoCajasSfccbdmq")
@ViewScoped
public class PagoCajaChicaBean implements Serializable {

    private static final long serialVersionUID = 1L;

//    private LazyDataModel<Cajas> listadoCajas;
    private List<Cajas> listadoCajas;
    private List<Kardexbanco> listadoKardex;
    private List<Cajas> listadoCajasSeleccionados;
    ...
    public ArrayList<Cajas> getMultiRow() {
        return (ArrayList<Cajas>) stateMap.getSelected();
    }
...
//        String empleadoString = (String) params.get("x");
        ...
        String observacionesForma = "PagoCajasVista";
        String empleadoString = (String) params.get("x");
...
//        }
    ...
    // fin perfiles
    /**
     * Creates a new instance of CajasEmpleadoBean
     */
    public PagoCajaChicaBean() {
//        listadoCajas = new LazyDataModel<Cajas>() {
//
//            @Override
//            public List<Cajas> load(int i, int i1, SortCriteria[] scs, Map<String, String> map) {
//                return null;
//            }
//        };
    }
...
//        String where = "o.fecha between :desde and :hasta  "
        String where1 = "o.kardexbanco is null and o.apertura is null";
        String where2 = "o.kardexbanco is null  and o.apertura.liquidado=false";
        String where = "";
        ...
        parametros.put(";where", where1 + where);
//        parametros.put("desde", desde);
//        parametros.put("hasta", hasta);
        try {

            listadoCajas = ejbCajas.encontarParametros(parametros);
            parametros.put(";where", where2 + where);
            List<Cajas> lista2 = ejbCajas.encontarParametros(parametros);
            listadoCajas.addAll(lista2);
    ...
    public String pagarSeleccionados() {
        boolean si = false;
        if (listadoCajasSeleccionados == null) {
            MensajesErrores.advertencia("No hay nada para pagar");
            return null;
        }
        for (Cajas p : listadoCajasSeleccionados) {
//            if (p.isSeleccionado()) {
            si = true;
...
//        kardex.setBeneficiario(caja.getEmpleado().getEntidad().toString());
    ...
    public String modificaTabla(Cajas caja) {
        if (!caja.getLiquidado()) {
            MensajesErrores.advertencia("Solo paga cajas no liquidadas");
            return null;
        }
        this.caja = caja;
        kardex = new Kardexbanco();
    ...
    public String imprimeTabla(Cajas caja) {

        this.caja = caja;
        kardex = caja.getKardexbanco();
//        Map parametros = new HashMap();
//        parametros.put(";where", "o.caja=:caja");
//        parametros.put("caja", caja);
//        parametros.put(";orden", "o.anio,o.mes");
//        try {
//            listaCajaes = ejbAmmortizaciones.encontarParametros(parametros);
//
//        } catch (ConsultarException ex) {
//            MensajesErrores.fatal(ex.getMessage());
...
//        }
    ...
    public String traer53() {
        ...
        try {
            Codigos cajaChica = codigosBean.traerCodigo("GASTGEN", "C");
            Map parametros = new HashMap();
...
//                **************************************************************
//                k.setEgreso(Integer.parseInt(df1.format(spi.getId()) + "" + df1.format(++i)));
                k.setSpi(spi);
...
//                    r.setAuxiliar(p.getEmpleado().getEntidad().getPin());
                    ...
                    cab.setOpcion("PAGO_CAJAS_CHICAS_APERTURA");
                    ejbCabecera.edit(cab, parametrosSeguridad.getLogueado().getUserid());
//                    listaRetorno.add(r);
//                    estaEnRenglones(listaRetorno, r);
                } else {
                    // cuenta proveedor
...
//                    r.setAuxiliar(p.getEmpleado().getEntidad().getPin());
                    ...
                    r1.setReferencia(cab.getDescripcion());
                    ejbRenglones.create(r1, parametrosSeguridad.getLogueado().getUserid());
                    cab.setOpcion("PAGO_CAJAS_CHICAS_REEMBOLSO");
                    ejbCabecera.edit(cab, parametrosSeguridad.getLogueado().getUserid());
//                    listaRetorno.add(r);
//                    estaEnRenglones(listaRetorno, r);
                }
                ...
                if (p.getApertura() != null) {
                    ...
                    parametros.put(";where", "o.vale.caja=:caja and o.detallecompromiso is not null");
                    parametros.put("caja", p);
                    List<Detallesvales> listaVales = ejbvales.encontarParametros(parametros);
                    for (Detallesvales v : listaVales) {
                        Ejecutado e = new Ejecutado();
                        e.setDetallecomrpomiso(v.getDetallecompromiso());
                        e.setValor(v.getValor());
        ...
        formulario.cancelar();
        listadoCajasSeleccionados = new LinkedList<>();
...
//                String numeroCuenta = k.getCuentatrans();
    ...
    public List<Renglones> getConsultaAsiento() {
        ...
        Map parametros = new HashMap();
        parametros.put(";where", "o.cabecera.idmodulo=:id and o.cabecera.modulo=:modulo and o.cabecera.opcion='CAJA CHICA'");
        ...
        try {
            ...
            MensajesErrores.fatal(ex.getMessage());
            Logger
                    .getLogger(PagoCajaChicaBean.class
...
//            paremetros.put("que", que);
     ...
     */
    public List<Cajas> getListadoCajas() {
        return listadoCajas;
    }
     ...
     */
    public void setListadoCajas(List<Cajas> listadoCajas) {
    ...
    /**
     * @return the listadoCajasSeleccionados
     */
    public List<Cajas> getListadoCajasSeleccionados() {
        return listadoCajasSeleccionados;
    }

    /**
     * @param listadoCajasSeleccionados the listadoCajasSeleccionados to set
     */
    public void setListadoCajasSeleccionados(List<Cajas> listadoCajasSeleccionados) {
        this.listadoCajasSeleccionados = listadoCajasSeleccionados;
    }

    public String colocar(int i) {
        Cajas k = listadoCajas.get(i);
    ...
    public String retirar(int i) {
        Cajas k = listadoCajasSeleccionados.get(i);
        k.setSeleccionado(true);
    ...
    public String colocarTodas() {
        ...
        int i = 0;
        listadoCajasSeleccionados = new LinkedList<>();
        for (Cajas k : listadoCajas) {
            listadoCajasSeleccionados.add(k);
        }
        listadoCajas = new LinkedList<>();
    ...
    public String colocarSeleccionados() {
        ...
        int i = 0;
        List<Cajas> lista = new LinkedList<>();
        for (Cajas k : listadoCajas) {
...
//        listadoCajas = new LinkedList<>();
    ...
    public String retirarTodas() {
        ...
        int i = 0;
        for (Cajas k : listadoCajasSeleccionados) {
            listadoCajas.add(k);
        }
        listadoCajasSeleccionados = new LinkedList<>();
        return null;
    ...
    public String retirarSeleccionados() {
        ...
        for (Cajas k : listadoCajasSeleccionados) {
            if (k.isSeleccionado()) {
                k.setSeleccionado(false);
                listadoCajas.add(k);
//                listadoCajasSeleccionados.remove(i);
            } else {
                k.setSeleccionado(false);
                lista.add(k);
            }
