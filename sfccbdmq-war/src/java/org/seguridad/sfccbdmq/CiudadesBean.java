 ...
 * @author edwin
 */
@ManagedBean(name = "ciudadesSfccbdmq")
@ViewScoped
public class CiudadesBean implements Serializable {
    ...
    private void activar() {
        ...
        String nombreForma = "CiudadesVista";
        if (perfil == null) {
...
//        }
        if (provincia == null) {
            MensajesErrores.advertencia("Seleccione una provincia");
            return null;
        }
...
//        }
        ...
        try {
            ...
            parametros.put(";where", "o.provincia=:provincia");
            parametros.put("provincia", provincia);
            ubicaciones = ejbUbicacion.encontarParametros(parametros);
        } catch (ConsultarException ex) {
            MensajesErrores.fatal(ex.getMessage() + " : " + ex.getCause());
            Logger.getLogger(CiudadesBean.class.getName()).log(Level.SEVERE, null, ex);
        }
...
//        }
    ...
    public SelectItem[] getComboCiudadesEspacio() {
        if (provincia == null) {
            return null;
        }
        try {
    ...
    public SelectItem[] getComboCiudades() {
        if (provincia == null) {
            return null;
        }
        try {
