 ...
 * @author edison
 */
@ManagedBean(name = "reporteFondosConsolidadoSfccbdmq")
@ViewScoped
public class ReporteFondosConsalodadoBean implements Serializable {
     ...
     */
    public ReporteFondosConsalodadoBean() {
    }
...
//        }
    ...
    private void llenarFondos() {
        try {
            ...
            List<Fondos> listaFondos = ejbFondos.encontarParametros(parametros);
            for (Fondos ca : listaFondos) {
                ...
                if (!lista.isEmpty()) {
                    ...
                    List<Object[]> listaAgrupados = ejbFondos.sumar(parametros);
                    ...
                    for (Object[] o : listaAgrupados) {
                        Fondos fondoApertura = (Fondos) o[0];
                        int id = (int) o[1];
                        String pin = (String) o[2];
                        BigDecimal valorApertura = (BigDecimal) o[3];
                        int kardex;

                        aMeses.setFondo(fondoApertura);
                        aMeses.setId(id);
...
//                        if (valor == 0) {
//                            if (fondoApertura.getKardexbanco() != null) {
//                                kardex = fondoApertura.getKardexbanco().getId();
...
//                        }
            ...
            Logger.getLogger(ReporteFondosConsalodadoBean.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public double traerValor(Date desde, Date hasta, int idmodulo) {
        ...
        String where = "o.cabecera.fecha between :desde and :hasta"
                + " and o.cabecera.opcion in ('LIQUIDACION_FONDOS')"
    ...
    public double traerValorKardex(Date desde, Date hasta, int idmodulo) {
        ...
        String where = "o.cabecera.fecha between :desde and :hasta"
                + " and o.cabecera.opcion in ('PAGO_CAJAS_CHICAS_REEMBOLSO')"
                + " and o.cabecera.idmodulo=:idmodulo and o.valor>0";
        parametros.put("desde", desde);
        parametros.put("hasta", hasta);
        parametros.put("idmodulo", idmodulo);
