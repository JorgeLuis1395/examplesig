 ...
 * @author edwin
 */
@ManagedBean(name = "reporteIngresoActivosSfccbdmq")
@ViewScoped
public class ReporteIngresoActivosBean {

    /**
     * Creates a new instance of ActivoBean
     */
    public ReporteIngresoActivosBean() {
    ...
    private void activar() {
        ...
        String nombreForma = "ReporteIngresoActivosVista";
        if (perfil == null) {
