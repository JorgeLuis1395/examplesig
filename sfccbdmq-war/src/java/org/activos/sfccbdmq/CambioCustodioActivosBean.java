...
//            setListaEntidades(ejbEntidades.encontarParametros(parametros));
    ...
    public String reporte(Activos activo) {
        ...
        try {
            ...
            pdf.agregaParrafoCompleto("ACTA DE ENTREGA-RECEPCIÓN", AuxiliarReporte.ALIGN_CENTER, 9, false);
            ...
            pdf.agregaParrafoCompleto(("En la ciudad de Quito, a los " + dia + " dias del mes de " + nomMes + " del " + anio + " en forma libre y voluntaria comparecen por la parte "
                    + "los señores en sus respectivas calidades: BODEGA CENTRAL-, quien entrega los bienes y el Sr.(a/ita). " + custodio + ", quien los "
                    ...
                    + "realizar la presente acta de Entrega-Recepción General de los bienes institucionales que a contuniación se detallan:"), AuxiliarReporte.ALIGN_JUSTIFIED, 9, false);
            pdf.agregaParrafoCompleto("\n\n", AuxiliarReporte.ALIGN_CENTER, 9, false);
