 ...
 * @author edwin
 */
@ManagedBean(name = "cambioVidaActivosSfccbdmq")
@ViewScoped
public class CambioVidaActivosBean {

    /**
     * Creates a new instance of ActivoBean
     */
    public CambioVidaActivosBean() {
...
//    private int tamano;
    ...
    private void activar() {
        ...
        String nombreForma = "CambioVidaActivosVista";
        if (perfil == null) {
...
//    }
    ...
    public String modifica() {
        ...
        imagenesBean.Buscar();
        vidaAnterior = activo.getVidautil();
        Map parametros = new HashMap();
        ...
        try {
            ...
            String custodio = "Vida Util Actual : " + vidaAnterior;
            getTacking().setDescripcion(custodio);
            getTacking().setCuenta1(activo.getVidautil().toString());
            getTacking().setFecha(new Date());
            getTacking().setTipo(4);
...
//            if (vidaAnterior <= 0) {
//                MensajesErrores.advertencia("Es Necesario cambio de vida util");
//                return true;
//            }
            if (vidaAnterior == activo.getVidautil()) {
                MensajesErrores.advertencia("Es Necesario cambio de vida util");
                return true;
            }
        } else {
            activo.setVidautil(0);
        }
        return false;
    }
    ...
    public String grabar() {
        ...
        try {
            tacking.setCuenta2(activo.getVidautil().toString());
...
//    }
    ...
    /**
     * @param vidaAnterior the vidaAnterior to set
     */
    public void setVidaAnterior(int vidaAnterior) {
