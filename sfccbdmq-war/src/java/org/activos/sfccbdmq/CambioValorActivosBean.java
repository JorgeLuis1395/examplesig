 ...
 * @author edwin
 */
@ManagedBean(name = "cambioValorActivosSfccbdmq")
@ViewScoped
public class CambioValorActivosBean {

    /**
     * Creates a new instance of ActivoBean
     */
    public CambioValorActivosBean() {
...
//    private int tamano;
    ...
    private void activar() {
        ...
        String nombreForma = "CambioValorActivosVista";
        if (perfil == null) {
...
//    }
    ...
    public String modifica() {
        ...
        try {
            ...
            tacking.setValor(new Float(valorAnterior));
            getTacking().setFecha(new Date());
            getTacking().setTipo(3);
...
//        }
        if (valorAnterior != 0) {
            if (valorAnterior == activo.getValoralta().doubleValue()) {
                MensajesErrores.advertencia("Es Necesario cambio de valor");
                return true;
            }
        }
        return false;
    ...
    public String grabar() {
        ...
        try {
            DecimalFormat df = new DecimalFormat("###,###,###,##0.00");
            String custodio = "Valor  : " + df.format(activo.getValoralta());
            tacking.setValornuevo(activo.getValoralta().floatValue());
