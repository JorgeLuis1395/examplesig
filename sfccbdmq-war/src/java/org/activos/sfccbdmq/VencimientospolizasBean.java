 ...
 * @author edwin
 */
@ManagedBean(name = "vencimientosPolizasSfccbdmq")
@ViewScoped
public class VencimientospolizasBean {

    /**
     * Creates a new instance of AuxiliarCalendarioBean
     */
    public VencimientospolizasBean() {
    }
    ...
    @EJB
    private PolizasFacade ejbPolizas;
    ...
    public String buscar() {
        ...
        for (int i = 0; i < ultimo_dia; i++) {
            ...
            parmetros.put(";where", "o.hasta=:vencimiento");
            parmetros.put("vencimiento", c.getTime());
            try {
                List<Polizas> lista = ejbPolizas.encontarParametros(parmetros);
                garantias = "";
                for (Polizas g : lista) {
                ...
                Logger.getLogger(VencimientospolizasBean.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void activar() {
        ...
        String nombreForma = "VencimientoPolizasVista";
        if (perfil == null) {
